 ...
 *
 * @param params
 * @param params.num The number to bound, can be a number, string, or undefined * @param params.max The maximum value
 *   the number can be
 * @param params.min The minimum value the number can be * @param params.rollover If true, the number will wrap around
 *   when it exceeds the bounds
