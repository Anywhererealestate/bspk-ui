 ...
 *
 * * @param target {HTMLElement | null} The target element to observe for mutations. * * @param callback
 * {MutationCallback} The callback function to execute when mutations are observed.
 *
